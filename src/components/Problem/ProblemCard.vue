        ...
        <div class="flex flex-wrap items-center gap-y-4">
          ...
          <div class="ml-3 flex flex-wrap place-items-center gap-x-3" v-if="!preview">
            <router-link
              ...
              :to="`/courses/${$route.params.name}/problem/${$route.params.id}/submit`"
            >
              <i-uil-file-upload-alt class="lg:h-5 lg:w-5" /> {{ $t("components.problem.card.submit") }}
            </router-link>
            <router-link
              class="btn md:btn-md lg:btn-lg"
              :to="`/courses/${$route.params.name}/problem/${$route.params.id}/stats`"
            >
            ...
            <router-link
              ...
              data-tip="Copycat"
              :to="`/courses/${$route.params.name}/problem/${$route.params.id}/copycat`"
            >
            ...
            <router-link
              ...
              data-tip="Edit"
              :to="`/courses/${$route.params.name}/problem/${$route.params.id}/edit`"
            >
