    ...
    <aside class="left">
      <div class="avatar-wrap" ref="avatarWrap">
        ...
        >
          ...
          <button class="pop-item" role="menuitem" @click="triggerFilePicker('file')">上傳檔案</button>
          <div class="divider"></div>
          <button class="pop-item" role="menuitem" @click="triggerFilePicker('library')">照片圖庫</button>
    ...
    <main class="right">
      <div class="info-grid one-col">
        ...
        <div class="field">
          ...
          <div v-if="editingField !== 'username'" class="box editable" @click="enterEdit('username')">
            {{ form.username || "—" }}
          </div>
        ...
        <div class="field">
          ...
          <div v-if="editingField !== 'email'" class="box editable" @click="enterEdit('email')">
            {{ form.email || "—" }}
          </div>
        ...
        <div class="field">
          ...
          <input
            ...
            class="box input"
            v-model="form.id"
            @keydown.enter.prevent="commit('id')"
            @keydown.esc.prevent="cancel('id')"
            @blur="commit('id')"
        ...
        <div class="field">
          ...
          <div
            v-if="editingField !== 'intro'"
            class="box h-167 editable top-left"
